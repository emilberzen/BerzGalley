...
namespace Tenkoku.Demo
{
    public class ui_tenkokuHandler : MonoBehaviour
    {
        ...
        void Start()
        {
            //get main object
            tenkokuObject =
                GameObject.Find("Tenkoku DynamicSky").GetComponent<Tenkoku.Core.TenkokuModule>() as
                    Tenkoku.Core.TenkokuModule;
            uiCanvasScale = this.transform.GetComponent<UnityEngine.UI.CanvasScaler>() as UnityEngine.UI.CanvasScaler;

            //find UI objects
            sliderTOY =
                GameObject.Find("Slider_TimeOfYear").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderTOD =
                GameObject.Find("Slider_TimeOfDay").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderLat =
                GameObject.Find("Slider_Latitude").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderTmult =
                GameObject.Find("Slider_TimeMult").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderAtSkyBright =
                GameObject.Find("Slider_AtSkyBright").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderAtNightBright =
                GameObject.Find("Slider_AtNightBright").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderAtFog = GameObject.Find("Slider_AtFog").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderAtDensity =
                GameObject.Find("Slider_AtDensity").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderWeAltoStratus =
                GameObject.Find("Slider_WeAltoStratus").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderWeCirrus =
                GameObject.Find("Slider_WeCirrus").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderWeCumulus =
                GameObject.Find("Slider_WeCumulus").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderWeOvercast =
                GameObject.Find("Slider_WeOvercast").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderWeRain =
                GameObject.Find("Slider_WeRain").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderWeSnow =
                GameObject.Find("Slider_WeSnow").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderWeWind =
                GameObject.Find("Slider_WeWind").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderWeWindD =
                GameObject.Find("Slider_WeWindD").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderWeLightning =
                GameObject.Find("Slider_WeLightning").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
            sliderWeRainbow =
                GameObject.Find("Slider_WeRainbow").GetComponent<UnityEngine.UI.Slider>() as UnityEngine.UI.Slider;
        ...
        void LateUpdate()
        {
            ...
            float dayVal = Mathf.Lerp(1f, 12.99f, sliderTOY.value) -
                           Mathf.FloorToInt(Mathf.Lerp(1f, 12.99f, sliderTOY.value));
            tenkokuObject.currentDay = Mathf.FloorToInt(Mathf.Lerp(1f, 30f, dayVal));
            textTOY.text = tenkokuObject.currentMonth + "/" + tenkokuObject.currentDay + "/" + tenkokuObject.yearValue;

            //set Time of Day
            if (Math.Abs(sliderTmult.value) < 0.001)
            {
                tenkokuObject.currentHour = Mathf.FloorToInt(Mathf.Lerp(0f, 24f, sliderTOD.value));
                var minuteVal = Mathf.Lerp(0f, 24f, sliderTOD.value) - tenkokuObject.currentHour;
                tenkokuObject.currentMinute = Mathf.FloorToInt(Mathf.Lerp(0f, 60f, minuteVal));
                var secondVal = Mathf.Lerp(0f, 60f, minuteVal) - tenkokuObject.currentMinute;
                tenkokuObject.currentSecond = Mathf.FloorToInt(Mathf.Lerp(0f, 60f, secondVal)); 
            ...
            tenkokuObject.fogDistance = Mathf.Lerp(0.0f, 5000.0f, sliderAtFog.value);
