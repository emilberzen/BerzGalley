...
float _tenkokuTimer;
		...
		fixed4 LightingCloudLight(SurfaceOutput s, fixed3 lightDir, half3 viewDir, fixed atten){
			...
			col.rgb = col.rgb * lerp(1.0,fCol,saturate(dot(-viewDir,Tenkoku_SunFwd_half)));
...
col.a = col.a * (1-saturate(_Tenkoku_overcastColor.a*4.0));
			...
			col.rgb = col.rgb * lerp(0.95,fCol,saturate(dot(-viewDir,Tenkoku_SunFwd_half)));
			col.rgb = saturate(lerp(skyColor.rgb * 1.15,col.rgb,depth));
...
col.a = col.a * (1-saturate(_Tenkoku_overcastColor.a*4.0));
			...
			col.rgb += (saturate(1.0-_Tenkoku_Ambient) * _Tenkoku_Nightlight * 40 * (1.0-saturate(pow(0.998,dot(-viewDir,Tenkoku_Vec_MoonFwd.xyz)-0.5))));
			half3 fCol = lerp(half3(1,1,1),lerp(_TenkokuCloudColor.rgb,half3(1,1,1),_Tenkoku_overcastColor.a*2),lerp(0.0,0.8,dot(-Tenkoku_SunFwd_half,viewDir)));
			col.rgb = col.rgb * lerp(0.9,fCol,saturate(dot(-viewDir,Tenkoku_SunFwd_half)));
			col.rgb = saturate(lerp(skyColor.rgb * 1.15,col.rgb,depth));
			col.rgb = lerp(col.rgb,col.rgb*max(1,(3*saturate(dot(-viewDir,Tenkoku_SunFwd_half)))),saturate(dot(-viewDir,Tenkoku_SunFwd_half)));
...
col.a = col.a * (1-saturate(_Tenkoku_overcastColor.a*4.0));
			...
			col.rgb += (saturate(1.0-_Tenkoku_Ambient) * _Tenkoku_Nightlight * 40 * (1.0-saturate(pow(0.998,dot(-viewDir,Tenkoku_Vec_MoonFwd.xyz)-0.5))));
			half3 fCol = lerp(half3(1,1,1),lerp(_TenkokuCloudColor.rgb,half3(1,1,1),_Tenkoku_overcastColor.a*2),lerp(0.0,0.8,dot(-Tenkoku_SunFwd_half,viewDir)));
			col.rgb = col.rgb * lerp(0.85,fCol,saturate(dot(-viewDir,Tenkoku_SunFwd_half)));
			col.rgb = saturate(lerp(skyColor.rgb * 1.15,col.rgb,depth));
...
col.a = col.a * (1-saturate(_Tenkoku_overcastColor.a*4.0));
			...
			col.rgb += (saturate(1.0-_Tenkoku_Ambient) * _Tenkoku_Nightlight * 40 * (1.0-saturate(pow(0.998,dot(-viewDir,Tenkoku_Vec_MoonFwd.xyz)-0.5))));
			half3 fCol = lerp(half3(1,1,1),lerp(_TenkokuCloudColor.rgb,half3(1,1,1),_Tenkoku_overcastColor.a*2),lerp(0.0,0.8,dot(-Tenkoku_SunFwd_half,viewDir)));
			col.rgb = col.rgb * lerp(0.8,fCol,saturate(dot(-viewDir,Tenkoku_SunFwd_half)));
			col.rgb = saturate(lerp(skyColor.rgb * 1.15,col.rgb,depth));
			col.rgb = lerp(col.rgb,col.rgb*max(1,(2*saturate(dot(-viewDir,Tenkoku_SunFwd_half)))),saturate(dot(-viewDir,Tenkoku_SunFwd_half)));
...
col.a = col.a * (1-saturate(_Tenkoku_overcastColor.a*4.0));
			...
			col.rgb = col.rgb * lerp(0.75,fCol,saturate(dot(-viewDir,Tenkoku_SunFwd_half)));
			col.rgb = saturate(lerp(skyColor.rgb * 1.15,col.rgb,depth));
...
col.a = col.a * (1-saturate(_Tenkoku_overcastColor.a*4.0));
			...
			col.rgb = col.rgb * lerp(0.65,fCol,saturate(dot(-viewDir,Tenkoku_SunFwd_half)));
			col.rgb = saturate(lerp(skyColor.rgb * 1.15,col.rgb,depth));
...
col.a = col.a * (1-saturate(_Tenkoku_overcastColor.a*4.0));
			...
			col.rgb = col.rgb * lerp(0.6,fCol*0.9,saturate(dot(-viewDir,Tenkoku_SunFwd_half)));
...
skyColor.rgb += Tenkoku_LightningLightIntensity * 1.4; 
			col.rgb = saturate(lerp(skyColor.rgb * 1.15,col.rgb,depth));
...
//lightning
half3 lCol = half3(0.89,0.85,0.68);
half cMask = saturate(lerp(-0.3,2.0,s.Albedo.r));

//bolt lightning
col.rgb += (Tenkoku_LightningLightIntensity * 0.03 * (1-s.Albedo.r));
col.rgb += saturate((saturate(dot(-viewDir,Tenkoku_Vec_LightningFwd.xyz)-0.2)) * Tenkoku_LightningLightIntensity * 0.7 * s.Albedo.r);
...
//lightning root
col.rgb += ((saturate(dot(-viewDir,Tenkoku_Vec_LightningFwd.xyz)-0.9998)) * Tenkoku_LightningLightIntensity * 2930.8 * s.Albedo.r);
